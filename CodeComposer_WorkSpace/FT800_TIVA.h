...
#define CMD_SAVE_CONTEXT    0x22000000
#define CMD_RESTORE_CONTEXT 0x23000000

#define CMD_LINEWIDTH		0x0E000000   //ERROR EN LA DOCUMENTACION: PONE 0x06000000

/*Defines añadidos por nosotros en este proyecto*/
#define CMD_BITMAP_SOURCE    0x01000000
#define CMD_BITMAP_LAYOUT    0x07000000
#define FORMAT_L1            (1<<19)
#define FORMAT_RGB332        (4<<19)
#define CMD_BITMAP_TRANSFORM_A 0x15000000
#define CMD_BITMAP_TRANSFORM_E 0x19000000
#define CMD_BITMAP_SIZE      0x08000000
#define CMD_VERTEX2II        (2<<30)
/*----------------------------------------------*/
